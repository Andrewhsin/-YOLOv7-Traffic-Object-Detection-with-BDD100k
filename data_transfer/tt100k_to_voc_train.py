...
tt100k_parent_dir = "E:/yolor-main/cancer"

work_sapce_dir = os.path.join(tt100k_parent_dir, "OBJ_Train_Datasets/")
if not os.path.isdir(work_sapce_dir):
    os.mkdir(work_sapce_dir)
work_sapce_dir = os.path.join(work_sapce_dir, "Train_Images/")
if not os.path.isdir(work_sapce_dir):
    os.mkdir(work_sapce_dir)
...
datadir = "E:/yolor-main/TrainAnnotations"
